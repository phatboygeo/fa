...
skins = {
    uef = {
        ...
        imagerMeshVert = "/meshes/game/map-border_vert_uef_mesh",
    ...
    aeon = {
        ...
        imagerMeshVert = "/meshes/game/map-border_vert_aeon_mesh",
        imagerMeshDetailsVert = "/meshes/game/map-border_vert_aeon_a_mesh",
        bodyColor = "FFc7e98a",
    ...
    cybran = {
        ...
        imagerMeshVert = "/meshes/game/map-border_vert_cybran_mesh",
        bodyColor = "FFe24f2d",
    ...
    seraphim = {
        ...
        imagerMeshVert = "/meshes/game/map-border_vert_sera_mesh",
        imagerMeshDetailsVert = "/meshes/game/map-border_vert_sera_a_mesh",
        bodyColor = "FFffd700",
